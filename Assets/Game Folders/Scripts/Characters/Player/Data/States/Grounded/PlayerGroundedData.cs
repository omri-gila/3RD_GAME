...
namespace MovementSystem
{
    ...
    public class PlayerGroundedData
    {
       ...
       [field: SerializeField][field: Range(0f, 5f)] public float GruondToFallRayDistance { get; private set; } =1f;
       ...
       [field: SerializeField] public List<playerCamra> SidewaysCameraRecenteringData { get; private set; }
